...
def evaluate(cfg: DictConfig) -> Tuple[Dict[str, Any], Dict[str, Any]]:
    ...
    checkpoint_cfg_path = os.path.abspath(os.path.join(cfg.ckpt_path, "../../.hydra/config.yaml"))
    if os.path.exists(checkpoint_cfg_path):
        cfg_from_checkpoint = OmegaConf.load(checkpoint_cfg_path)
        ...
        log.warning(
            "Checkpoint-side Hydra config not found at %s. "
            "Falling back to the active eval model config.",
            checkpoint_cfg_path,
        )
